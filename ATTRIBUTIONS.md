...
This document records the dependency and interoperability review for Command Center 1.0.0. Command Center itself is distributed under the MIT License; see [`LICENSE`](LICENSE).
