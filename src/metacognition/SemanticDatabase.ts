...
export class SemanticDatabase {
	...
	constructor(private readonly driver: SQLiteDriver, private readonly dimensions: number, private readonly path = SEMANTIC_DATABASE_PATH, private readonly vssExtension = 'vss0') {
...
`);
	...
	private requireOpen(): SQLiteConnection { if (!this.connection) throw new Error('Semantic database is not open.'); return this.connection; }
